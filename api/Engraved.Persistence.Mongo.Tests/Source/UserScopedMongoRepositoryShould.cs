...
public class UserScopedMongoRepositoryShould
{
  ...
  public async Task UpsertEntry_Ensures_CurrentUser_Id()
  {
    ...
    IEntry[] entries = await _repository.GetEntriesForJournal(journalId, null, null, null, null);
  ...
  public async Task GetAllEntries()
  {
    ...
    IEntry[] otherUserEntries = await _userScopedRepository.GetEntriesForJournal(
      otherUserJournalId,
      null,
      null,
      null,
    ...
    IEntry[] currentUserEntries = await _userScopedRepository.GetEntriesForJournal(
      currentUserJournalId,
      null,
      null,
      null,
      null
